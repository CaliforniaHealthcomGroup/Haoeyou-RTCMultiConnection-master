    ...
    function FileSelector() {
        ...
        function selectFile(callback, multiple, directory) {
            ...
            file.onchange = function() {
                ...
                if (file.files[0].name.length>18){
                    console.log("File Name: " + file.files[0].name );
                    console.error("File name too long: " + file.files[0].name.length);
                    alert("File name too long: " + file.files[0].name.length + ". Please keep the file name less than 14.");
                    return;
                }
